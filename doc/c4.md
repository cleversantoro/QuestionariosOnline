...
```mermaid
flowchart LR
    respondent[Respondente (Cidadao/participante)] -. HTTPS .-> publicSite[Site Publico ASP.NET Core MVC]
    analyst[Pesquisador ou Admin (Usuario interno)] -. HTTPS .-> adminPortal[Portal Admin ASP.NET Core MVC]
